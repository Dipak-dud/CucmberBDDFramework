...
public class LoginPage {
    ...
    //By locators
    private By emailInputLoactor = By.name("email");
    private By passwordInputLoactor = By.name("password");
    ...
    public void enterEmail(String email) {
        WebElement emailInput = driver.findElement(emailInputLoactor);
        emailInput.sendKeys(email);
    }
    public void enterPassword(String password) {
        WebElement passwordInput = driver.findElement(passwordInputLoactor);
